    ...
    <div>
      ...
      <div className="codesense-section">
        <div className="codesense-left">
          <h2 className="codesense-left-head">CodeSense.</h2>
          <p className="codesense-left-caption">CodeSense is a platform that helps you learn coding by solving real-world problems. It's a platform that helps you learn coding by solving real-world problems.</p>
          <button className="codesense-left-btn"><a href="https://codesense.scopeclub.in" target="_blank" rel="noopener noreferrer">Visit</a></button>
        </div>
