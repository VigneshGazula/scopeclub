    ...
    <div>
      ...
      <div className="wdwd">
        ...
        <div className="wdwd-04">
            <h3 className="wdwd-04-head">Projects</h3>
            <p className="wdwd-04-content">At SCOPE Club, we believe that coding is more than just solving problems—it's about building real-world solutions. Through our project-based learning approach, we encourage students to collaborate, innovate, and develop projects that have a tangible impact.</p>
          </div>
